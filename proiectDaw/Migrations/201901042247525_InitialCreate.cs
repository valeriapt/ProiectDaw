namespace proiectDaw.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Pictures", "Categories_Id", "dbo.Categories");
            DropForeignKey("dbo.Albums", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Pictures", "Albums_Id", "dbo.Albums");
            DropForeignKey("dbo.Pictures", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Comments", "Pictures_Id", "dbo.Pictures");
            ...
            DropIndex("dbo.Comments", new[] { "Pictures_Id" });
            DropIndex("dbo.Comments", new[] { "User_Id" });
            DropIndex("dbo.Pictures", new[] { "Categories_Id" });
            DropIndex("dbo.Pictures", new[] { "Albums_Id" });
